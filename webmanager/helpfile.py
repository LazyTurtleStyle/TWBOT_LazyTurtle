help_file = {
    ...
    'defence.dodge': 'Dodge the incoming attacks whose name contains the trigger text. While OFF nothing leaves; a dodge that is already out is still brought home.',
